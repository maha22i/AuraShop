...
export default function ChildrenProducts() {
  ...
  return (
    <div className="pt-16 bg-gray-50">
      {/* En-tête */}
      <div className="bg-gradient-to-r from-blue-100 to-green-200 py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="mt-4 text-lg md:text-xl text-gray-600">
            Explorez notre sélection pour les enfants. Vêtements de qualité et confort pour les petits.
          </p>
        </div>
      </div>
          ...
          >
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <select
                ...
                className="border border-gray-300 rounded-md p-2 bg-white text-sm focus:ring focus:ring-blue-300"
              >
